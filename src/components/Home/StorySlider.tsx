                  ...
                  <CardContent className="min-h-[125px] flex flex-col aspect-square items-center justify-center p-0 relative">
                    {story?.storyImage && story?.caption && <>
                      <Image
                        ...
                        width={300}
                      />
                      <p className="absolute bottom-0 py-1 bg-white w-full text-center text-main">{story?.caption}</p>
                      <div className="absolute top-2 left-2 flex items-center gap-2">
                        <Image className="rounded-full border-2 border-blue-500 object-cover" alt="user-photo" src={story?.image} height={30} width={30} />
                    ...
                    {!story?.storyImage && story?.caption &&
                      <>
                        <div className="bg-main rounded-lg flex items-center justify-center h-full w-full">
                          <p className="px-4 text-center text-sm text-white font-bold">{story?.caption}</p>
                        </div>
                        <div className="absolute top-2 left-2 flex items-center gap-2">
                        <Image className="rounded-full border-2 border-blue-500 object-cover" alt="user-photo" src={story?.image} height={30} width={30} />
                        <p className="text-white text-sm font-semibold">{story?.name}</p>
